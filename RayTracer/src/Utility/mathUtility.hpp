...
namespace utility
{
	...
	public:
		...
		static ai_real fresnel(const aiVector3D& incidenceVector, const aiVector3D& incidenceNormal, const ai_real ior)
		{
		...
		static aiVector3D calculateRefractionDirection(const aiVector3D& incidenceVector, const aiVector3D& incidenceNormal, const ai_real ior)
		{
		...
		//          G R O U N D 
		static aiVector3D calculateReflectionDirection(const aiVector3D& incidenceVector, const aiVector3D& incidenceNormal)
		{
